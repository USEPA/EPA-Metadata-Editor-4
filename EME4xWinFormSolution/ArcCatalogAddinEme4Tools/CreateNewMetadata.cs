...
{
    public class CreateNewMetadata : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        ...
        protected override void OnClick()
        {
            try
            {
                if (MessageBox.Show("Existing metadata will be erased. Are you sure you want to continue?", "Please Confirm",
        ...
        private void loadXmlFromSelection(IGxObject selectedObject)
        {
            ...
            else
            {
                ...
                if (gxMetadata != null)
                {
                    ...
                    string genericMDRecord = @"<gmd:MD_Metadata xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:gco=""http://www.isotc211.org/2005/gco"" xmlns:gmd=""http://www.isotc211.org/2005/gmd"" xmlns:xlink=""http://www.w3.org/1999/xlink"" xsi:schemaLocation=""http://www.isotc211.org/2005/gmi http://www.ngdc.noaa.gov/metadata/published/xsd/schema.xsd""></gmd:MD_Metadata>";

                    esriXmlString = genericMDRecord;
